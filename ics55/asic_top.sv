...
`ifdef GPIO_SPLIT
    .\gpio_in[0]        (ip4_gpio_in[0]),
    .\gpio_in[1]        (ip4_gpio_in[1]),
    .\gpio_in[2]        (ip4_gpio_in[2]),
    .\gpio_in[3]        (ip4_gpio_in[3]),
    .\gpio_out[0]       (ip4_gpio_out[0]),
    .\gpio_out[1]       (ip4_gpio_out[1]),
    .\gpio_out[2]       (ip4_gpio_out[2]),
    .\gpio_out[3]       (ip4_gpio_out[3]),
`else
    .gpio_in            (ip4_gpio_in),
