...
module tb_riscv64_execution;
    ...
    task test_r_type_alu;
        ...
        `endif
            ...
            set_inputs(64'h80000004, 32'h402080b3, 64'h87654321, 64'h12345678, 64'h0, 16'b1001000000000000); // reg_op=1, alu_op=001 (SUB) - alu_op移至bit14-12
            check_alu_result(test_id++, 1, 64'h87654321 - 64'h12345678);

            // SLL (0x002090b3 - SLL x1, x0, x2)
            set_inputs(64'h80000008, 32'h002090b3, 64'h0000000000000001, 64'h0000000000000004, 64'h0, 16'b1111110000000000); // reg_op=1, alu_op=111 (SLL) - alu_op移至bit14-12
            check_alu_result(test_id++, 2, 64'h0000000000000010);

            // SLT (0x0020a0b3 - SLT x1, x0, x2)
            set_inputs(64'h8000000c, 32'h0020a0b3, 64'h0000000000000001, 64'h0000000000000002, 64'h0, 16'b1101000000000000); // reg_op=1, alu_op=101 (SLT) - alu_op移至bit14-12
            check_alu_result(test_id++, 3, 64'h0000000000000001);

            // SLTU (0x0020b0b3 - SLTU x1, x0, x2)
            set_inputs(64'h80000010, 32'h0020b0b3, 64'h0000000000000001, 64'h0000000000000002, 64'h0, 16'b1110000000000000); // reg_op=1, alu_op=110 (SLTU) - alu_op移至bit14-12
            check_alu_result(test_id++, 4, 64'h0000000000000001);

            // XOR (0x0020c0b3 - XOR x1, x0, x2)
            set_inputs(64'h80000014, 32'h0020c0b3, 64'h0000000000000001, 64'h0000000000000003, 64'h0, 16'b1100000000000000); // reg_op=1, alu_op=100 (XOR) - alu_op移至bit14-12
            check_alu_result(test_id++, 5, 64'h0000000000000002);

            // SRL (0x0020d0b3 - SRL x1, x0, x2)
            set_inputs(64'h80000018, 32'h0020d0b3, 64'h0000000000000010, 64'h0000000000000004, 64'h0, 16'b1101000000000000); // reg_op=1, alu_op=101 (SRL - 与SLT复用) - alu_op移至bit14-12
            check_alu_result(test_id++, 6, 64'h0000000000000001);

            // SRA (0x4020d0b3 - SRA x1, x0, x2)
            set_inputs(64'h8000001c, 32'h4020d0b3, 64'h8000000000000000, 64'h0000000000000004, 64'h0, 16'b1101000000000000); // reg_op=1, alu_op=101 (SRA - 与SLT复用) - alu_op移至bit14-12
            check_alu_result(test_id++, 7, 64'hf800000000000000);

            // OR (0x0020e0b3 - OR x1, x0, x2)
            set_inputs(64'h80000020, 32'h0020e0b3, 64'h0000000000000001, 64'h0000000000000002, 64'h0, 16'b1011000000000000); // reg_op=1, alu_op=011 (OR) - alu_op移至bit14-12
            check_alu_result(test_id++, 8, 64'h0000000000000003);

            // AND (0x0020f0b3 - AND x1, x0, x2)
            set_inputs(64'h80000024, 32'h0020f0b3, 64'h0000000000000003, 64'h0000000000000001, 64'h0, 16'b1010000000000000); // reg_op=1, alu_op=010 (AND) - alu_op移至bit14-12
    ...
    task test_i_type_alu;
        ...
        `endif
            ...
            set_inputs(64'h80000028, 32'h00200093, 64'h12345678, 64'h0, 64'h0000000000000002, 16'b0000001100000000); // alu_src=1, alu_op=000 (ADD), reg_write=1 - bit14-12=alu_op
            check_alu_result(test_id++, 10, 64'h12345678 + 64'h0000000000000002);

            // Note: RISC-V I扩展没有SUBI指令，通常使用ADDI并传入负数来实现减法
            // I-type SUB测试已被移除，因为它不符合RISC-V规范

            // I-type AND (0x00200093 - ANDI x1, x0, 2)
            set_inputs(64'h80000030, 32'h00200093, 64'h0000000000000003, 64'h0, 64'h0000000000000002, 16'b0010001100000000); // alu_src=1, alu_op=010 (AND), reg_write=1 - bit14-12=alu_op
            check_alu_result(test_id++, 12, 64'h0000000000000002 & 64'h0000000000000003);

            // I-type OR (0x00200093 - ORI x1, x0, 2)
            set_inputs(64'h80000034, 32'h00200093, 64'h0000000000000001, 64'h0, 64'h0000000000000002, 16'b0011001100000000); // alu_src=1, alu_op=011 (OR), reg_write=1 - bit14-12=alu_op
            check_alu_result(test_id++, 13, 64'h0000000000000001 | 64'h0000000000000002);

            // I-type XOR (0x00200093 - XORI x1, x0, 2)
            set_inputs(64'h80000038, 32'h00200093, 64'h0000000000000003, 64'h0, 64'h0000000000000002, 16'b0100001100000000); // alu_src=1, alu_op=100 (XOR), reg_write=1 - bit14-12=alu_op
            check_alu_result(test_id++, 14, 64'h0000000000000003 ^ 64'h0000000000000002);

            // I-type SLT (0x00200093 - SLTI x1, x0, 2)
            set_inputs(64'h8000003c, 32'h00200093, 64'h0000000000000001, 64'h0, 64'h0000000000000002, 16'b0101001100000000); // alu_src=1, alu_op=101 (SLT), reg_write=1 - bit14-12=alu_op
            ...
            set_inputs(64'h80000040, 32'h00200093, 64'h0000000000000001, 64'h0, 64'h0000000000000002, 16'b0110001100000000); // alu_src=1, alu_op=110 (SLTU), reg_write=1 - bit14-12=alu_op
            check_alu_result(test_id++, 16, (64'h0000000000000001 < 64'h0000000000000002) ? 64'd1 : 64'd0);

            // I-type SLL (0x00200093 - SLLI x1, x0, 2)
            set_inputs(64'h80000044, 32'h00200093, 64'h0000000000000001, 64'h0, 64'h0000000000000004, 16'b0111001100000000); // alu_src=1, alu_op=111 (SLL), reg_write=1 - bit14-12=alu_op
