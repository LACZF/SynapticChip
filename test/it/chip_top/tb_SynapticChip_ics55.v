...
`endif
    ...
    asic_top u_asic_top (
        ...
        .io_pad0           (uart_rx),
        .io_pad1           (uart_tx),
        .io_pad2           (chip_gpio_in[0]),
        .io_pad3           (chip_gpio_in[1]),
        .io_pad4           (chip_gpio_in[2]),
        .io_pad5           (chip_gpio_in[3]),
        .io_pad6           (chip_gpio_out[0]),
        .io_pad7           (chip_gpio_out[1]),
        .io_pad8           (chip_gpio_out[2]),
        .io_pad9           (chip_gpio_out[3]),
        .io_pad10          (jtag_tck_pin),
        .io_pad11          (jtag_tms_pin),
        .io_pad12          (jtag_tdi_pin),
        .io_pad13          (jtag_tdo_pin),
        .io_pad14          (),
        .io_pad15          (),
        .io_pad16          (),
        .io_pad17          (),
...
`endif
    ...
    /********** 输出波形 **********/
    initial begin
        $dumpfile("tb_SynapticChip_ics55.vcd");
        $dumpvars(0, tb_SynapticChip_ics55);
    end
