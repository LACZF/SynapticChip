...
module top_system #(
    ...
    ram_node #(
        ...
        .tx_req_ring_mask_i(tx_req_ring_mask[`NODE_RAM*NUM_RINGS +: NUM_RINGS]),
        .tx_req_ring_disable_i(tx_req_ring_disable[`NODE_RAM*NUM_RINGS +: NUM_RINGS]),
        .tx_req_valid_i(tx_req_valid[`NODE_RAM]),
        .tx_req_is_order_i(tx_req_is_order[`NODE_RAM]),
        .tx_req_opcode_i(tx_req_opcode[`NODE_RAM*OPCODE_WIDTH +: OPCODE_WIDTH]),
        .tx_req_match_type_i(tx_req_match_type[`NODE_RAM*MATCH_TYPE_WIDTH +: MATCH_TYPE_WIDTH]),
        .tx_req_source_id_i(tx_req_source_id[`NODE_RAM*NODE_ID_WIDTH +: NODE_ID_WIDTH]),
        .tx_req_target_id_i(tx_req_target_id[`NODE_RAM*NODE_ID_WIDTH +: NODE_ID_WIDTH]),
        .tx_req_addr_i(tx_req_addr[`NODE_RAM*ADDR_WIDTH +: ADDR_WIDTH]),
        .tx_req_data_i(tx_req_data[`NODE_RAM*DATA_WIDTH +: DATA_WIDTH]),

        .rx_req_valid_o(rx_req_valid[`NODE_RAM]),
        .rx_req_is_order_o(rx_req_is_order[`NODE_RAM]),
        .rx_req_opcode_o(rx_req_opcode[`NODE_RAM*OPCODE_WIDTH +: OPCODE_WIDTH]),
        .rx_req_match_type_o(rx_req_match_type[`NODE_RAM*MATCH_TYPE_WIDTH +: MATCH_TYPE_WIDTH]),
        .rx_req_source_id_o(rx_req_source_id[`NODE_RAM*NODE_ID_WIDTH +: NODE_ID_WIDTH]),
        .rx_req_target_id_o(rx_req_target_id[`NODE_RAM*NODE_ID_WIDTH +: NODE_ID_WIDTH]),
        .rx_req_addr_o(rx_req_addr[`NODE_RAM*ADDR_WIDTH +: ADDR_WIDTH]),
        .rx_req_data_o(rx_req_data[`NODE_RAM*DATA_WIDTH +: DATA_WIDTH]),

        .rsp_valid_o(rsp_valid[`NODE_RAM]),
        .rsp_source_id_o(rsp_source_id[`NODE_RAM*NODE_ID_WIDTH +: NODE_ID_WIDTH]),
        .rsp_target_id_o(rsp_target_id[`NODE_RAM*NODE_ID_WIDTH +: NODE_ID_WIDTH]),
        .rsp_addr_o(rsp_addr[`NODE_RAM*ADDR_WIDTH +: ADDR_WIDTH]),
        .rsp_data_o(rsp_data[`NODE_RAM*DATA_WIDTH +: DATA_WIDTH])
    );
    ...
    rom_node #(
        ...
        .tx_req_ring_mask_i(tx_req_ring_mask[`NODE_ROM*NUM_RINGS +: NUM_RINGS]),
        .tx_req_ring_disable_i(tx_req_ring_disable[`NODE_ROM*NUM_RINGS +: NUM_RINGS]),
        .tx_req_valid_i(tx_req_valid[`NODE_ROM]),
        .tx_req_is_order_i(tx_req_is_order[`NODE_ROM]),
        .tx_req_opcode_i(tx_req_opcode[`NODE_ROM*OPCODE_WIDTH +: OPCODE_WIDTH]),
        .tx_req_match_type_i(tx_req_match_type[`NODE_ROM*MATCH_TYPE_WIDTH +: MATCH_TYPE_WIDTH]),
        .tx_req_source_id_i(tx_req_source_id[`NODE_ROM*NODE_ID_WIDTH +: NODE_ID_WIDTH]),
        .tx_req_target_id_i(tx_req_target_id[`NODE_ROM*NODE_ID_WIDTH +: NODE_ID_WIDTH]),
        .tx_req_addr_i(tx_req_addr[`NODE_ROM*ADDR_WIDTH +: ADDR_WIDTH]),
        .tx_req_data_i(tx_req_data[`NODE_ROM*DATA_WIDTH +: DATA_WIDTH]),

        .rx_req_valid_o(rx_req_valid[`NODE_ROM]),
        .rx_req_is_order_o(rx_req_is_order[`NODE_ROM]),
        .rx_req_opcode_o(rx_req_opcode[`NODE_ROM*OPCODE_WIDTH +: OPCODE_WIDTH]),
        .rx_req_match_type_o(rx_req_match_type[`NODE_ROM*MATCH_TYPE_WIDTH +: MATCH_TYPE_WIDTH]),
        .rx_req_source_id_o(rx_req_source_id[`NODE_ROM*NODE_ID_WIDTH +: NODE_ID_WIDTH]),
        .rx_req_target_id_o(rx_req_target_id[`NODE_ROM*NODE_ID_WIDTH +: NODE_ID_WIDTH]),
        .rx_req_addr_o(rx_req_addr[`NODE_ROM*ADDR_WIDTH +: ADDR_WIDTH]),
        .rx_req_data_o(rx_req_data[`NODE_ROM*DATA_WIDTH +: DATA_WIDTH]),

        .rsp_valid_o(rsp_valid[`NODE_ROM]),
        .rsp_source_id_o(rsp_source_id[`NODE_ROM*NODE_ID_WIDTH +: NODE_ID_WIDTH]),
        .rsp_target_id_o(rsp_target_id[`NODE_ROM*NODE_ID_WIDTH +: NODE_ID_WIDTH]),
        .rsp_addr_o(rsp_addr[`NODE_ROM*ADDR_WIDTH +: ADDR_WIDTH]),
        .rsp_data_o(rsp_data[`NODE_ROM*DATA_WIDTH +: DATA_WIDTH])
    );
