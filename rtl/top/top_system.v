...
module top_system (
    ...
    riscv_bus_interface riscv_if (
        ...
        .ring_data(ring_data[`NODE_RISCV*`DATA_WIDTH +: `DATA_WIDTH]),
    ...
    ram_node ram (
        ...
        .ring_in_data(ring_data[`NODE_RAM*`DATA_WIDTH +: `DATA_WIDTH]),
        ...
        .ring_out_data(ring_data[(`NODE_RAM+1)%`NODES*`DATA_WIDTH +: `DATA_WIDTH]),
    ...
    rom_node rom (
        ...
        .ring_in_data(ring_data[`NODE_ROM*`DATA_WIDTH +: `DATA_WIDTH]),
        ...
        .ring_out_data(ring_data[(`NODE_ROM+1)%`NODES*`DATA_WIDTH +: `DATA_WIDTH]),
    ...
    gpio_node gpio (
        ...
        .ring_in_data(ring_data[`NODE_GPIO*`DATA_WIDTH +: `DATA_WIDTH]),
        ...
        .ring_out_data(ring_data[(`NODE_GPIO+1)%`NODES*`DATA_WIDTH +: `DATA_WIDTH]),
    ...
    uart_node uart (
        ...
        .ring_in_data(ring_data[`NODE_UART*`DATA_WIDTH +: `DATA_WIDTH]),
        ...
        .ring_out_data(ring_data[(`NODE_UART+1)%`NODES*`DATA_WIDTH +: `DATA_WIDTH]),
    ...
    synaptic_core fabric (
        ...
        .ring_in_data(ring_data[`NODE_FABRIC*`DATA_WIDTH +: `DATA_WIDTH]),
        ...
        .ring_out_data(ring_data[(`NODE_FABRIC+1)%`NODES*`DATA_WIDTH +: `DATA_WIDTH]),
