...
module bus_if (
	...
	input  wire				   reset,
	/********** 流水线控制信号 **********/
	input  wire				   stall_i,		   // 延迟信号
	input  wire				   flush_i,		   // 刷新信号
	output reg				   busy_o,		   // 总线忙信号
	/********** CPU接口 **********/
	input  wire [`WordAddrBus] addr_i,		   // 地址
	input  wire				   as_n_i,		   // 地址有效
	input  wire				   rw_i,		   // 读/写
	...
	output reg				   bus_req_n_o,    // 请求
	output reg	[`WordAddrBus] bus_addr_o,	   // 地址
	output reg				   bus_as_n_o,	   // 地址选通
	output reg				   bus_rw_o,	   // 读/写
	output reg	[`WordDataBus] bus_wr_data_o   // 写入的数据
);
