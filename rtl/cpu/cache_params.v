...
// Cache parameters
`define CACHE_OFFSET_BITS   6       // 64-byte cache line
`define CACHE_INDEX_BITS    6       // 64 sets
`define CACHE_TAG_BITS      52      // 64-bit address - 6 - 6 = 52 bits
`define CACHE_LINE_SIZE     64      // bytes
`define CACHE_NUM_LINES     64      // 64 cache lines
`define CACHE_NUM_WAYS      4       // 4-way set associative
