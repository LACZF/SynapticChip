...
module bus_top #(
    ...
    input  wire [(NUM_PES*DATA_WIDTH)-1:0]        pe_status_i,
    input  wire [(NUM_PES*DATA_WIDTH)-1:0]        pe_outputs_i,
    input  wire [NUM_PES-1:0]                     pe_busy_i,
    ...
    input  wire [DATA_WIDTH-1:0]                  uart_data_out_i,
    input  wire                                   uart_ack_i,
    input  wire                                   uart_txd_i,
    output                                        uart_rxd_o,
    input  wire                                   uart_rts_i,
    output                                        uart_cts_o,
