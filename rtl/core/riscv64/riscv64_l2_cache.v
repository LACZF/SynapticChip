...
module l2_cache_64bit #(
    ...
    // L1缓存接口
    input wire [63:0] l1_req_addr,
    input wire [63:0] l1_req_data,
    output reg [63:0] l1_resp_data,
    input wire l1_req_we,
    input wire [7:0] l1_req_sel,
    ...
    output reg [63:0] flash_data_out,
    input wire [63:0] flash_data_in,
